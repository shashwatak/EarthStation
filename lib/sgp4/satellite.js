...
function twoline2rv(longstr1, longstr2){
	...
	if(longstr1.substring(53, 54) == "-") {
		satrec.bstar        = parseFloat("." + parseInt(longstr1.substring(54, 59), 10) + "E" + longstr1.substring(59, 61))*-1;
		
	}
	else satrec.bstar        = parseFloat("." + parseInt(longstr1.substring(53, 59), 10) + "E" + longstr1.substring(59, 61));
	...
	console.log("satnum="+satrec.satnum+", bstar="+satrec.bstar);
	console.log( longstr1.substring(53, 54));
...
function sgp4(satrec, tsince){
    ...
    *    vallado, crawford, hujsak, kelso  2006
    ...
    if (pl < 0.0){
        ...
        vz    =  sini * cossu;
         //Everything past this doesnt not work
	...
	//console.log("$$$ [r,v]="+[r,v]);	// NaN and curry
    return [r, v];
}
...
function eci_to_geodetic (eci_coords, gmst) {
    ...
    var h = (R/Math.cos(latitude)) - (a*C); //height
...
function doppler_factor (my_location, position, velocity) {
	...
	//console.log("negatived");
	return (-1);
	}
	};
    //range_rate *= sign(range_rate);
	//console.log(range_rate);
