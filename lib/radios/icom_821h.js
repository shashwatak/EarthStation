icom_821h = (function() {
  ...
  function send_icom_command (connectionId, serial_out_data, callback) {
    ...
    if (connectionId > 0){
      ...
      chrome.serial.write(connectionId, serial_out_data, icom_write_callback);
    }
    else {
